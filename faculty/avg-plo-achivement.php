...
<?php
    ...
    //}
      ...
      // $query = "SELECT SUM(q1_co) AS m1, SUM(q2_co) AS m2,
      //         SUM(q3_co) AS m3, SUM(q4_co) AS m4 ,
      //         SUM(q5_co) AS m5, SUM(q6_co) AS m6 
      //         FROM  marks_exam";
      $query = "SELECT q1_co AS m1, q2_co AS m2,
              q3_co AS m3, q4_co AS m4 ,
              q5_co AS m5, q6_co AS m6 
              FROM  marks_exam WHERE course_id='$course_Name'";
                    ...
                    <div class="col-md-4 pr-1">
                      <div class="form-group">
                        ...
                        <select class="selectpicker" data-size="7" data-style="btn btn-primary btn-round btn-block" name="course" id="view-picker" title="Select a Course">
                            ...
                            <option value="CSE-203">CSE-203</option>
